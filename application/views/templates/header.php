...
<!--Permintaan-->
	<link rel="stylesheet" href="<?= base_url()?>assets/css/all-style.css">
...
<body id="page-top">
  ...
  <img href="<?= base_url()?>" src="<?= base_url()?>assets/images/logoOWS.png" alt="OWS LOGO" style="width:8%">
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link dropdown-toggle" href="<?php echo site_url('accept')?>" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
		...
		<div class="dropdown-divider"></div>
          <a class="dropdown-item" href="<?= site_url()?>laporan">Laporan</a>
      </li>
